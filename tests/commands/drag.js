            ...
            if (!window.dragMock) {
                ...
                !function t(e, r, n) {
                    function a(i, u) {
                        if (!r[i]) {
                            if (!e[i]) {
                                var s = 'function' == typeof require && require;if (!u && s) return s(i, !0);if (o) return o(i, !0);var c = new Error('Cannot find module \'' + i + '\'');throw c.code = 'MODULE_NOT_FOUND', c;
                            }var f = r[i] = { exports: {} };e[i][0].call(f.exports, function (t) {
                                var r = e[i][1][t];return a(r ? r : t);
                            }, f, f.exports, t, e, r, n);
                        }return r[i].exports;
                    ...
                    var n = t('./src/index.js');'function' == typeof define && define('dragMock', function () {
                        return n;
                    }), window.dragMock = n;
                }, { './src/index.js': 5 }], 2: [function (t, e, r) {
                    function n(t, e) {
                        var r = t.indexOf(e);r >= 0 && t.splice(r, 1);
                    }var a = function a() {
                    ...
                    }, a.prototype.setDragImage = function () {}, e.exports = a;
                }, {}], 3: [function (t, e, r) {
                    function n() {}function a(t, e, r) {
                        var _typeof = typeof Symbol === "function" && typeof Symbol.iterator === "symbol" ? function (obj) { return typeof obj; } : function (obj) { return obj && typeof Symbol === "function" && obj.constructor === Symbol ? "symbol" : typeof obj; };
                        if ('function' == typeof e && (r = e, e = null), !t || 'object' != (typeof t === 'undefined' ? 'undefined' : _typeof(t))) throw new Error('Expected first parameter to be a targetElement. Instead got: ' + t);return { targetElement: t, eventProperties: e || {}, configCallback: r || n };
                    }function o(t, e, r) {
                        e && (e.length < 2 ? r && e(t) : e(t, t.type));
                    }function i(t, e, r, n, a, i) {
                        e.forEach(function (e) {
                            var s = u.createEvent(e, a, n),
                                c = e === r;o(s, i, c), t.dispatchEvent(s);
                        });
                    }var u = t('./eventFactory'),
                         s = t('./DataTransfer'),
                         c = function c() {
                        ...
                        var n = a(t, e, r),
                            o = ['mousedown', 'dragstart', 'drag'],
                            u = new s();return this._queue(function () {
                        ...
                        var n = a(t, e, r),
                            o = ['mousemove', 'mouseover', 'dragenter'];return this._queue(function () {
                    ...
                    function n(t, e) {
                        ...
                        'DragEvent' === e && (e = 'CustomEvent');var a = window[e],
                                                                     o = { view: window, bubbles: !0, cancelable: !0 };n(o, r);var i = new a(t, o);return n(i, r), i;
                    }function o(t, e, r) {
                        var a;switch (e) {case 'MouseEvent':
                            a = document.createEvent('MouseEvent'), a.initEvent(t, !0, !0);break;default:
                            a = document.createEvent('CustomEvent'), a.initCustomEvent(t, !0, !0, 0);}return r && n(a, r), a;
                    }function i(t, e, r) {
                        try {
                            return a(t, e, r);
                        } catch (n) {
                    ...
                    }var u = t('./DataTransfer'),
                         s = ['drag', 'dragstart', 'dragenter', 'dragover', 'dragend', 'drop', 'dragleave'],
                         c = { createEvent: function createEvent(t, e, r) {
                             var n = 'CustomEvent';t.match(/^mouse/) && (n = 'MouseEvent');var a = i(t, n, e);return s.indexOf(t) > -1 && (a.dataTransfer = r || new u()), a;
                         } };e.exports = c;
                }, { './DataTransfer': 2 }], 5: [function (t, e, r) {
                    function n(t, e, r) {
                        return t[e].apply(t, r);
                    }var a = t('./DragDropAction'),
                         o = { dragStart: function dragStart(t, e, r) {
                             return n(new a(), 'dragStart', arguments);
                         }, dragEnter: function dragEnter(t, e, r) {
                             return n(new a(), 'dragEnter', arguments);
                         }, dragOver: function dragOver(t, e, r) {
                             return n(new a(), 'dragOver', arguments);
                         }, dragLeave: function dragLeave(t, e, r) {
                             return n(new a(), 'dragLeave', arguments);
                         }, drop: function drop(t, e, r) {
                             return n(new a(), 'drop', arguments);
                         }, delay: function delay(t, e, r) {
                             return n(new a(), 'delay', arguments);
                         }, DataTransfer: t('./DataTransfer'), DragDropAction: t('./DragDropAction'), eventFactory: t('./eventFactory') };e.exports = o;
